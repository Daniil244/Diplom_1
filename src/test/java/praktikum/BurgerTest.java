...
public class BurgerTest {
    ...
    public void addIngredientTest() {
        ...
        assertEquals("Список ингредиентов не корректен", listExpected, burger.ingredients);
    }
    ...
    public void getPriceTest() {
        ...
        assertEquals("Значение стоимости не корректно", expectedPrice, burger.getPrice(), DELTA);
    }
    ...
    public void getReceiptTest() {
        ...
        assertTrue("Рецепт не корректен",
